<td valign="top" class="tdmain">
    <b style="color:red;">[ Ket qua tim kiem! ]</b><br/>
    <?php
    $name=$_POST['name'];
...
<td width = "150" align="center">
    <a href = "index.php?mod=product&acr=detail&id=<?php echo $rows['id']; ?>">
    <img src="<?php echo $rows['photo']; ?>" width ="100"height="100">
    <br/>
    <b> <?php echo truncateString($rows['name'],40,true);?></b>
     <br/>
        </a>
        Gia: <b style="color:red;"><?php echo number_format ($rows['price']);?></b>đ
        <br/>
        </td>
        <?php
             if($d%4==0)
